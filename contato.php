...
<body>
    ...
    <section id="secaoContato">
        <div class="container">
            <div class="row">
                <div class="col-lg-7">
                    <h5 id="title">Orçamentos</h5>
                    <h3 id="titlePrincipalOrcamento">Solicite um orçamento para seu projeto</h3>
                    <p>Entraremos em contato com mais informações.</p>

                    <div id="formOrcamentoBox">
                        <form class="row g-3">
                            <!-- Campo: Nome -->
                            <div class="col-md-6">
                            ...
                            <!-- Campo: Quando iniciar o projeto? -->
                            <div class="col-md-6 mt-lg-5">
                                <label for="inputQuandoIniciar" class="form-label">Quando iniciar o projeto?</label>
                                <select name=""  class="form-select">
                                    <option value="1">Imediatamente</option>
                                    <option value="2">Em 1 a 3 meses</option>
                                    <option value="3">Em 6 meses</option>
                                </select>
                            </div>

                            <!-- Campo: Qual é a sua necessidade? -->
                            <div class="col-md-6 mt-lg-5">
                                <label for="inputNecessidade" class="form-label">Qual é a sua necessidade?</label>
                                <input class="form-control" id="inputNecessidade" rows="3" placeholder="Descreva sua necessidade"></input>
                            </div>

                            <!-- Botão: Enviar -->
                            <div class="col-12">
                                <button type="submit" class="btn" id="btnCtaForm">Solicitar Orçamento</button>
                            </div>
                        </form>
                    </div>
                </div>
                ...
                <div class="col-lg-5">
                    <img src="imgs/imgContato.webp" alt="Imagem Formulário de Contato" id="imgContato" class="img-fluid">
                </div>
            </div>
        </div>
    </section>
    ...
    <section id="duvidas">
        <div class="container">
            <div class="row" id="rowContato">
                <div class="col-lg-8" id="colContato">
                    <h5 id="title">Contato</h5>
                    <h3 id="titlePrincipalContato">Tire suas dúvidas antes do orçamento</h3>
                    <p>Entraremos em contato com mais informações.</p>
                </div>
                ...
                <div class="col-lg-4">
                    ...
                    <div class="col-md-12 mt-4">
                        ...
                        <input type="email" class="form-control" id="inputTelefone" placeholder="Seu email">
                    </div>
                    
                    <!-- Campo: Dúvidas e/ou solicitações -->
                    <div class="col-md-12 mt-4">
                        <label for="inputNecessidade" class="form-label">Dúvidas e/ou solicitações</label>
                        <textarea class="form-control" id="inputNecessidade" rows="4" placeholder="Descreva sua necessidade"></textarea>
                    </div>
